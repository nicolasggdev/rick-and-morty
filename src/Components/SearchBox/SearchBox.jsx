...
const SearchBox = () => {
    ...
    const getData = () => {
        ...
        .then(res => setData(res.data)) // PENDIENTE, YA ME CONECTA CON LA API CORRECTAMENTE, AHORA DEBO MOSTRAR LA INFORMACION
        .catch(err => console.log(err))
    }

    const search = filterType => {
        if(filterType === "name"){
            return <input type="text" placeholder='Name of character' onChange={e => setFilter(e.target.value)}/>
            ...
            return <input type="text" placeholder='Name of species' onChange={e => setFilter(e.target.value)}/>
